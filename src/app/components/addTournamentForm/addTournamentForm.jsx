        ...
        <Row>
          <Col xs={12} md={6}>
            <Form.Group className="mb-3" controlId="tournamentName">
              ...
              <Form.Control type="text" placeholder="Open X" name="tournamentName" />
            </Form.Group>
          </Col>
          <Col xs={12} md={6}>
          ...
          <Col xs={12} md={6}>
            <Form.Group className="mb-3" controlId="tournamentGroups">
              ...
              <Form.Control type="number" placeholder='0' name="tournamentGroups"/>
            </Form.Group>
          </Col>
          <Col xs={12} md={6}>
            <Form.Group className="mb-3" controlId="tournamentParticipants">
              <Form.Label>Tamaño del torneo</Form.Label>
              <Form.Control type="number" placeholder='0' name="tournamentParticipants"/>
            </Form.Group>
          </Col>
          <Col xs={12}>
            <Form.Group className="mb-3" controlId="tournamentPlace">
              <Form.Label>Ubicación</Form.Label>
              <Form.Control type="text" placeholder="La Torre de Claramunt" name="tournamentPlace"/>
            </Form.Group>
          </Col>
          <Col xs={12}>
            <Form.Group className="mb-3" controlId="torunamentMode">
              ...
              <Form.Select name="torunamentMode">
                <option>Selecciona el modo del torneo (individual/singular)</option>
          ...
          <Col xs={12} className='d-flex justify-content-center'>
            <div className="wrapper col-12 col-md-6">
              <Button variant="primary" type='submit' className='text-center w-100 mt-4'>Crear torneo</Button>
